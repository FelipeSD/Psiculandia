...
//        long daysBetween = DateHelp.getDateDiff(ultimaDataLancada, dataHoje, TimeUnit.DAYS);
//        if(daysBetween < 7){
...
//        }
        ...
        long daysBetween = DateHelp.getDateDiff(ultimaDataLancada, dataHoje, TimeUnit.MILLISECONDS);
        if(daysBetween < 900){
            long diasParaNovoRegistro = 7 - daysBetween;
            System.out.println("Retorne daqui a " + diasParaNovoRegistro + " dias para registrar um novo histórico");
            return false;
